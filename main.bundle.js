...
/***/ function(module, exports, __webpack_require__) {
	...
	var bindKeys = __webpack_require__(30);
	var Setup = __webpack_require__(31);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var boardSettings = __webpack_require__(5);
	var LoadingArea = __webpack_require__(10);
	var ConveyorArea = __webpack_require__(14);
	var PlayerEvents = __webpack_require__(26);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getLaneStarts = __webpack_require__(6);
	var getvConveyorBeltStarts = __webpack_require__(7);
	var getvColorBlobStarts = __webpack_require__(8);
	var getLaneWorkerStarts = __webpack_require__(9);
	...
	function boardSettings() {
	  ...
	  var laneCount = 4;
	  var cellCount = 12;
	  var colors = [{ name: "yellow", selected: "#D4CA6A", bg: "#AA9F39" }, { name: "green", selected: "#5FAE57", bg: "#378B2E" }, { name: "red", selected: "#D1686D", bg: "#A7383E" }];
	  var drCategories = [3, 2, 1, 0];
	  var startingDrCount = 35;
	  var conveyorSpeed = 0.8;
	  var laneWorkerWorkSpeed = 0.33;
	  var laneWorkerSpeed = 0.63;
	  ...
	  return {
	    ...
	    laneWorkerWorkSpeed: laneWorkerWorkSpeed,
	    laneWorkerSpeed: laneWorkerSpeed,
	    beltEnd: beltEnd,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var loadingAreaSettings = __webpack_require__(11);
	var SelectedLane = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getBoardSettings = __webpack_require__(5);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(3);
	var selectedLaneSettings = __webpack_require__(13);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var conveyorAreaSettings = __webpack_require__(15);
	var Lane = __webpack_require__(16);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(3);
	var laneSettings = __webpack_require__(17);

	var ConveyorBelt = __webpack_require__(18);
	var LaneWorker = __webpack_require__(24);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(3);
	var conveyorBeltSettings = __webpack_require__(19);
	var Cell = __webpack_require__(20);
	var extend = __webpack_require__(22);
	var incGet = __webpack_require__(23);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cellSettings = __webpack_require__(21);
	var extend = __webpack_require__(22);
	var incGet = __webpack_require__(23);
...
/***/ function(module, exports) {
	...
	var incGet = {
	  ...
	  getBase: function getBase(x) {
	    return this.state.base[x];
	  },

	  incBase: function incBase(x, value) {
	    return this.state.base[x] += value;
	  },

	  getState: function getState(x) {
	    return this.state[x];
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var laneWorkerSettings = __webpack_require__(25);
	var extend = __webpack_require__(22);
	var incGet = __webpack_require__(23);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BlobEngine = __webpack_require__(27);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(3);
	var ColorBlob = __webpack_require__(28);
	...
	BlobEngine.prototype.putBlobs = function () {
	  ...
	  _.each(this.game.conveyorArea.lanes, (function (lane) {
	    ...
	    _.each(first_cells, (function (cell) {
	      if (cell.state.children.colorBlob && cell.state.children.colorBlob.state.colorIndex === this.game.getCurrentColorIndex() && cell) {
	        cell.state.children = {};
	      }
	    }).bind(this));
	  }).bind(this));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var colorBlobSettings = __webpack_require__(29);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function laneUp(game) {
	  return game.playerEvents.laneUp.bind(game.playerEvents);
	}

	function laneDown(game) {
	  return game.playerEvents.laneDown.bind(game.playerEvents);
	}

	function colorDown(game) {
	  return game.playerEvents.colorDown.bind(game.playerEvents);
	}

	function colorUp(game) {
	  return game.playerEvents.colorUp.bind(game.playerEvents);
	}

	function putBlob(game) {
	  return game.playerEvents.putBlobs.bind(game.playerEvents);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CanvasEngine = __webpack_require__(32);
	var UpdateEngine = __webpack_require__(33);
...
/***/ function(module, exports, __webpack_require__) {
	...
	CanvasEngine.prototype.render = function (gameComponent) {
	  return this.renderBase(gameComponent.state.base) && this.renderChildren(gameComponent.state.children);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(3);
	var LaneWorkerEngine = __webpack_require__(34);
	var CellEngine = __webpack_require__(35);
...
/***/ function(module, exports, __webpack_require__) {
	...
	LaneWorkerEngine.prototype.update = function (laneWorker) {
	  ...
	  if (laneWorker.state.working) {
	    ...
	    if (this.game.state.score % 1000 === 0) {
	      this.game.settings.laneWorkerWorkSpeed = this.game.settings.laneWorkerWorkSpeed * 1.02;
	      this.game.settings.laneWorkerSpeed = this.game.settings.laneWorkerSpeed * 1.02;
	    }
	...
	LaneWorkerEngine.prototype.getCurrentCell = function (laneWorker) {
	  if (!this.checkForCell(laneWorker)) {
	    return undefined;
	  }
	  ...
	  var cell = _.filter(cells, function (cell) {
	    return cell.state.base.x < laneWorker.state.base.x && laneWorker.state.base.x < cell.state.base.x + cell.state.base.width;
	  })[0];
...
/***/ function(module, exports, __webpack_require__) {
	...
	CellEngine.prototype.updateCell = function (cell) {
	  ...
	  if (cell.getChild("colorBlob")) {
	    cell.getChild("colorBlob").incBase("x", cell.settings.speed);
	  }
	};
