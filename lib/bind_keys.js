...
function laneUp(game) {
  return game.playerEvents.laneUp.bind(game);
}

function laneDown(game) {
  return game.playerEvents.laneDown.bind(game);
}

function colorDown(game) {
  return game.playerEvents.colorDown.bind(game);
}

function colorUp(game) {
  return game.playerEvents.colorUp.bind(game);
}


function putBlob(game) {
  return game.playerEvents.putBlob.bind(game);
}
