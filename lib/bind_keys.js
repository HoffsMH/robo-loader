...
function laneUp(game) {
  ...
  .laneUp.bind(game.playerEvents, game);
}

function laneDown(game) {
  return game.playerEvents
  .laneDown.bind(game.playerEvents, game);
}

function colorDown(game) {
  return game.playerEvents
  .colorDown.bind(game.playerEvents, game);
}

function colorUp(game) {
  return game.playerEvents
  .colorUp.bind(game.playerEvents, game);
}


function putBlob(game) {
  return game.playerEvents
  .putBlobs.bind(game.playerEvents, game);
}
